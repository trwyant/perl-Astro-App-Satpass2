package Astro::App::Satpass2::Test;
...
Astro::App::Satpass2::Test - Test Astro::App::Satpass2 classes

=head1 SYNOPSIS

 my $tst = Astro::App::Satpass2::Test->new( 'Astro::App::Satpass2' );
 $tst->plan( 'no_plan' );
 $tst->require_ok();
 $tst->can( 'new' );
 $tst->new_ok();
...
This class expedites the testing of classes in the C<Astro::App::Satpass2>
