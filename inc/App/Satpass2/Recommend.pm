package App::Satpass2::Recommend;
...
sub _recommend_astro_simbad_client {
    ...
    * Astro::SIMBAD::Client is not installed.
      ...
      App::Satpass2 sky() method, but is otherwise unused by this
...
sub _recommend_astro_spacetrack {
    ...
    * Astro::SpaceTrack version 0.016 or higher is not installed. This
      module is required for the App::Satpass2 st() method, but is
...
sub _recommend_date_manip {
    ...
    * Date::Manip is not installed.
      ...
      the 'App::Satpass2' documentation for the details.
EOD
...
sub _recommend_geo_webservice_elevation_usgs {
    ...
    * Geo::WebService::Elevation::USGS is not installed.
      This module is required for the App::Satpass2 height() method, but
...
sub _recommend_soap_lite {
    ...
    * SOAP::Lite is not installed.
      This module is required for the App::Satpass2 geocode() method,
...
sub _recommend_time_hires {
    ...
    * Time::HiRes is not installed.
      This module is required for the App::Satpass2 time() method, but
      is otherwise unused by this package. If you do not intend to use
