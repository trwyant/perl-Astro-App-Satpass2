package App::Satpass2::Test::Format;
...
sub format_fail {
    ...
    goto &App::Satpass2::Test::method_fail;
}
...
sub format_is {
    ...
    @_ = ( $self, $self->{+__PACKAGE__}{method}, @{
	    $self->{+__PACKAGE__}{args} }, $want, $test_name );
    goto &App::Satpass2::Test::method_is;
}
...
App::Satpass2::Test::Format - Test App::Satpass2::Format classes

=head1 SYNOPSIS

 my $tst = App::Satpass2::Test::Format->new(
     'App::Satpass2::Format::Classic' );
 $tst->plan( 'no_plan' );
 $tst->require_ok();
 $tst->can( 'new' );
...
C<App::Satpass2::Format> package. It subclasses
L<App::Satpass2::Test|App::Satpass2::Test>, overriding and adding
...
L<< $tst->method_fail()|App::Satpass2::Test/method_fail>, passing it the
...
$tst->method_is()|App::Satpass2::Test/method_is>, passing it the method
