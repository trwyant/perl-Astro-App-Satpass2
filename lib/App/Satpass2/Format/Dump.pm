package App::Satpass2::Format::Dump;
...
App::Satpass2::Format::Dump - Format App::Satpass2 output as dump.

=head1 SYNOPSIS

 use App::Satpass2::Format::Dump;
 my $fmt = App::Satpass2::Format::Dump->new();
...
by L<App::Satpass2::Format|App::Satpass2::Format>:
