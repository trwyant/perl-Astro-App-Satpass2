package App::Satpass2::FormatTime::Strftime;
...
App::Satpass2::FormatTime::Strftime - Provide common functionality for strftime-type time formatters.

=head1 SYNOPSIS

 package MyTimeFormatter;
 use base qw{ App::Satpass2::FormatTime::Strftime };
