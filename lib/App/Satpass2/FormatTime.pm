package App::Satpass2::FormatTime;
...
App::Satpass2::FormatTime - Format time for output.
...
This class abstracts time formatting for App::Satpass2.

=head1 METHODS

This class supports the following public methods in addition to those
inherited from L<App::Satpass2::Copier|App::Satpass2::Copier>.
