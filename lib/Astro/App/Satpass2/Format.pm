...
This method is intended to format the data from the
L<Astro::Coord::ECI::TLE alias()|Astro::Coord::ECI::TLE/alias> method.
Its argument is the hash returned by that method.

=head3 almanac

 print $fmt->almanac( [ \%almanac_hash ... ] );

This method is intended to format almanac entries for the
L<almanac|Astro::App::Satpass2/almanac> and
L<quarters|Astro::App::Satpass2/quarters> commands. Its argument is a
...
This method is intended to format Iridium flares for the
L<flare|Astro::App::Satpass2/flare> command. Its argument is a reference
to an array of hash references, which are presumed to be output from the
...
L<list|Astro::App::Satpass2/list> command. Its argument is a reference
to an array of L<Astro::Coord::ECI|Astro::Coord::ECI> or
...
This method is intended to format a brief description for the
L<location|Astro::App::Satpass2/location> command. Its argument is
...
This method is intended to format a description of satellite passes for
the L<pass|Astro::App::Satpass2/pass> command. Its argument is a
reference to an array of hash references, which are presumed to be
...
This method is intended to format a description of the phase of bodies
for the L<phase|Astro::App::Satpass2/phase> command.  Its argument is a
reference to an array of C<Astro::Coord::ECI|Astro::Coord::ECI> objects
which support the C<phase()> method and which have already had their
time set to the desired time.

=head3 position

 print $fmt->position( \%position_hash );

This method is intended to format the position (and possibly
other data) of a set of bodies for the L<position|Astro::App::Satpass2/position> command. Its
...
This method is intended to format the TLE of the bodies for the
L<tle|Astro::App::Satpass2/tle> command. Its argument is presumed to be
...
This method is intended to format the TLE data of the bodies for the
L<tle|Astro::App::Satpass2/tle> command with C<-verbose> specified. The
output is expected to be a labeled dump. Its argument is presumed to be
a reference to an array of
L<Astro::Coord::ECI::TLE|Astro::Coord::ECI::TLE> objects.
